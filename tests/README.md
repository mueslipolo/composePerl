...
| File                         | What it covers                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `deps.bats`                  | Arg parsing (including multiple `--module NAME NAME...` values in one `update` call), `carton update` vs `carton install` correctness, `/build` workdir, bundle hash naming, existing-bundle skip, symlink creation, UBI_IMAGE/IMAGE_NAME passthrough, build-info stamping (PERL_VERSION + UBI_IMAGE), precondition checks                                                                                                                                                         |
